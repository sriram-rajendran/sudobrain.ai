...
| Trust | source audit, privacy docs, public repo verifier, knowledge export, reversible review action log, approval bundles | citation cards and provenance details | advanced provenance graph UI |
